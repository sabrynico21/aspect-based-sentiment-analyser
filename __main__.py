...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', help='Path to the model (required for the test mode)')
    ...
    model = ClassificationModel(bert_model_name='bert-base-uncased', num_aspects=num_aspects, num_opinions=num_opinions)
    ...
    if args.mode == 'train':
        ...
        num_epochs = 10
        logging.basicConfig(filename='classification_model_metrics.log', level=logging.INFO, filemode='a') 
        ...
        predictions = model.predict(num_aspects, num_opinions, criterion_aspect, criterion_opinion, test_loader, args.model)
